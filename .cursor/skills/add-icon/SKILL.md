...
name: add-icon
description: >-
  Pull inline SVG icons from Icônes / Iconify into icons-template.js or
...
- [ ] 3. Insert into icons-template.js or icons-app.js
...
For unknown collections (`attributionKey: null`), show `attributionHint` and ask before adding a new `ICON_ATTRIBUTIONS` entry in `icons-template.js`.
...
Update the `Available:` list in the file you edited (`icons-template.js` or `icons-app.js`).
